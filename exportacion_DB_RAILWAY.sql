...
INSERT INTO `pv_disposiciones` VALUES ('CTE003','OBA001'),('CTE001','OBA002'),('CTE001','OBA003'),('CTE002','OBA004'),('CTE004','OBA005'),('CTE002','OBA006'),('CTE001','OBA007'),('CTE005','OBA008'),('CTE005','OBA009'),('CTE001','OBA010'),('CTE003','OBA011'),('CTE002','OBA012'),('CTE002','OBA013'),('CTE004','OBA014'),('CTE004','OBA015'),('CTE001','OBA016');
...
INSERT INTO `pv_insumos` VALUES ('ISO001',420.00,1,'Emulsión'),('ISO002',180.00,2,'Base Hidráulica'),('ISO003',534.45,3,'Lubricantes'),('ISO004',15.36,4,'Combustibles'),('ISO005',1440.02,5,'Mezcla Asfáltica'),('ISO006',1500.09,6,'Mezcla Asfáltica'),('ISO007',549.39,7,'Aceites');
...
INSERT INTO `pv_servicios` VALUES ('SVO001',42.35,8,'Insumos'),('SVO002',52.31,9,'Empleados'),('SVO003',41.61,10,'Insumos'),('SVO004',49.52,11,'Empleados'),('SVO005',52.48,12,'Insumos'),('SVO006',42.51,13,'Empleados'),('SVO007',60.73,14,'Insumos'),('SVO008',58.05,15,'Empleados');
...
DROP PROCEDURE IF EXISTS `sp_generar_id`;
CREATE PROCEDURE `sp_generar_id`(
